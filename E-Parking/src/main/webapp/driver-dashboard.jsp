							...
							<div class="col-lg-3 col-md-4 pd-left-none no-pd">
								<div class="main-left-sidebar no-margin">
									...
									<div class="tags-sec full-width">
										...
										<div class="cp-sec">
											<img src="images/Eparking_logo.PNG" alt="">
							...
							<div class="col-lg-6 col-md-8 no-pd">
								<div class="main-ws-sec">
									<div class="post-topbar">
										<div class="user-picy">
											<img src="images/resources/gab.PNG" alt="">
										</div>
										<div class="post-st">
											<ul>
							...
							<div class="col-lg-3 pd-right-none no-pd">
								<div class="right-sidebar">
									<div class="widget widget-about">
										<img src="images/Eparking_logo.PNG" alt="" width="30%">
										
										<span>E-parking Challan is a Traffic Fines payment system  </span>
										
										<div class="sign_link">
											<h3><a href="index.jsp" title="">Logout</a></h3>
